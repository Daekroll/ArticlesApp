...
Revision ID: 836eb866bb2d
Revises: 
Create Date: 2025-03-29 18:18:37.744449
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_articles_update_at'), 'articles', ['update_at'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_articles_update_at'), table_name='articles')
